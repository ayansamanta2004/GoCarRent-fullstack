  ...
  return (
    <motion.div
      ...
      <div className='text-white'>
        ...
        <p className='mt-2'>Monetize your vehicle effortlessly by listing it on GoCarRent.</p>
        <p className='max-w-130'>We take care of insurance, driver verification and decure payments - so you can earn passive income, stress-free.</p>
